-- ============================================================================
-- Migration: Fix find_nearby_accounts function to use account_snapshots
-- Date: 2026-02-09
-- Purpose: Fix "relation ofi_scores does not exist" error in Visit Planner
-- ============================================================================

-- Replace function to query account_snapshots instead of non-existent ofi_scores table
...
BEGIN
  ...
  SELECT
    ...
    -- Get latest OFI score from account_snapshots
    COALESCE(latest_ofi.ofi_score, 0)::INTEGER as ofi_score,
    a.owner_name,
