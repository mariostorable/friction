...
INSERT INTO client_name_aliases (jira_short_name, sf_account_name, notes) VALUES
  ...
  ('All Purpose',             'All Purpose Storage - CORP',                          NULL),
  ('Atomic Storage',          'Atomic Storage Group - CORP',                         NULL),
  ('Columbia',                'Columbia Storage Group - CORP.',                      NULL),
  ('Copper',                  'Copper Storage Solutions / Copper Safe Storage - CORP', NULL),
  ('Cubix',                   'Cubix Asset Management - CORP.',                      NULL),
  ('Five Star Storage',       'Five Star Storage - CORP',                            NULL),
  ('KO',                      'KO Storage - CORP.',                                  NULL),
  ('Metro',                   'A Metro Self Storage - CORP',                         NULL),
  ...
  ('MiniMall',                'Mini Mall Storage Properties LTD - CORP.',           NULL),
  ...
  ('Osprey',                  'Crystal View Capital - CORP.',                        NULL),
  ...
  ('StorQuest',               'William Warren Group - CORP.',                        NULL),
