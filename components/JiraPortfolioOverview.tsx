      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-green-50 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-medium text-green-700">Resolved (60d)</span>
          </div>
          <div className="text-2xl font-bold text-green-900">{data.portfolio.resolved_60d}</div>
        ...
        <div className="bg-purple-50 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-medium text-purple-700">120-Day Total</span>
          </div>
          <div className="text-2xl font-bold text-purple-900">{data.portfolio.resolved_120d}</div>
