"use strict";(()=>{var e={};e.id=458,e.ids=[458],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},14300:e=>{e.exports=require("buffer")},57246:(e,t,i)=>{i.r(t),i.d(t,{headerHooks:()=>_,originalPathname:()=>S,patchFetch:()=>v,requestAsyncStorage:()=>h,routeModule:()=>f,serverHooks:()=>w,staticGenerationAsyncStorage:()=>g,staticGenerationBailout:()=>I});var a={};i.r(a),i.d(a,{POST:()=>l});var n=i(95419),r=i(69108),o=i(99678),s=i(78070),c=i(57699),d=i(7439);let u=process.env.ANTHROPIC_API_KEY;async function l(e){try{let{account_id:t,briefing_type:i}=await e.json(),a=(0,c.createRouteHandlerClient)({cookies:d.cookies}),{data:{user:n}}=await a.auth.getUser();if(!n)return s.Z.json({error:"Unauthorized"},{status:401});let{data:r}=await a.from("accounts").select("*").eq("id",t).eq("user_id",n.id).single();if(!r)return s.Z.json({error:"Account not found"},{status:404});let{data:o}=await a.from("account_snapshots").select("*").eq("account_id",t).order("snapshot_date",{ascending:!1}).limit(1).single(),{data:u}=await a.from("friction_cards").select("*").eq("account_id",t).gte("created_at",new Date(Date.now()-2592e6).toISOString()).order("created_at",{ascending:!1}),{data:l}=await a.from("raw_inputs").select("*").eq("account_id",t).gte("created_at",new Date(Date.now()-2592e6).toISOString()).order("created_at",{ascending:!1}).limit(20),p=await m({account:r,snapshot:o,frictionCards:u||[],rawInputs:l||[],briefingType:i});return s.Z.json({briefing:p})}catch(e){return console.error("Error generating briefing:",e),s.Z.json({error:"Failed to generate briefing"},{status:500})}}async function m(e){let{account:t,snapshot:i,frictionCards:a,rawInputs:n,briefingType:r}=e,o="quick"===r?p(t,i,a):function(e,t,i,a){let n=p(e,t,i),r=a.slice(0,10).map(e=>`[${new Date(e.created_at).toLocaleDateString()}] ${e.text_content.substring(0,200)}...`).join("\n\n");return n+`
...
- Current score of ${a.toFixed(0)} means: ${a>=70?"HIGH FRICTION - Critical issues requiring immediate action":a>=40?"MEDIUM FRICTION - Notable issues to address":"LOW FRICTION - Account is healthy"}
...
Be specific with dates, numbers, and concrete details. Focus on what's most actionable for the visit.`}let f=new n.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/briefing/generate/route",pathname:"/api/briefing/generate",filename:"route",bundlePath:"app/api/briefing/generate/route"},resolvedPagePath:"/Users/mario/friction-intelligence/app/api/briefing/generate/route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:h,staticGenerationAsyncStorage:g,serverHooks:w,headerHooks:_,staticGenerationBailout:I}=f,S="/api/briefing/generate/route";function v(){return(0,o.patchFetch)({serverHooks:w,staticGenerationAsyncStorage:g})}}};var t=require("../../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),a=t.X(0,[456,552,421],()=>i(57246));module.exports=a})();