  ...
  try {
    ...
    const accountsToUpsert = uniqueAccounts.map((sfAccount: any) => {
      ...
      const accountData: any = {
        ...
        // Property address from Shipping address (physical location)
